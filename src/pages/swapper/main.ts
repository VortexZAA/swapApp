...
dotenv.config();
const signingKey =
  "566bc64748284e261e5ee63df8c7f71c29cff1f9244f1cd1143d985908a244a6" || "";
const rpcUrl =
  "https://api.stackup.sh/v1/node/9f6ebecfeb88c4084b37ee76dc541de352aecff3007a30cb09abf816f7762da8" ||
  "";
const paymasterUrl =
  process.env.PAYMASTER_URL ||
  "https://api.stackup.sh/v1/paymaster/9f6ebecfeb88c4084b37ee76dc541de352aecff3007a30cb09abf816f7762da8";
