...
const Ethereum = (props: Props) => {
  return (
    <div className="grid lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 w-full rounded-xl flex flex-wrap p-1 px-0 sm:p-2 sm:px-2 gap-2 justify-center">
      ...
      <a href='/sandbox-eth' className='text-center'>
          <Image src={sandbox} alt="Sandbox Logo" className="bg-white w-30 sm:w-60 rounded-lg h-auto mx-auto" />
          <h1 className='mt-2 font-hanson'>SANDBOX</h1>
      </a>
    </div>
  );
};
