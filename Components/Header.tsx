      ...
      <div className="mx-auto max-w-screen-xl px-4 py-32 flex h-screen items-center">
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="font-hanson bg-gradient-to-r from-white to-white bg-clip-text text-xl font-extrabold text-transparent sm:text-4xl">
            ...
            <span className="text-3xl sm:text-5xl bg-gradient-to-r from-purple to-green bg-clip-text">BETA-Z.</span>
          </h1>

          <p className="mx-auto mt-4 max-w-xl text-sm">
            Ready to energize your life and turn it into earnings? With Move to Earn, your steps
            hold real value. Simply walk, run, or exercise to earn. Each step matters.
          </p>
